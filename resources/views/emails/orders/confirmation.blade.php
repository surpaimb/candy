                  ...
                  <table align="center" border="0" cellpadding="15" cellspacing="0" width="100%" bgcolor="#FFFFFF" style="font-family: Tahoma, Geneva, sans-serif; border-left: 1px solid #d4f0fc; border-right: 1px solid #d4f0fc; border-bottom: 4px solid #d4f0fc;">
                    <tr>
                      <td align="left">
                        ...
                        <p>Thank you for shopping with GetCandy, your order is now being processed.</p>
                        <p>If you need any help with your order, please contact us at <a href="mailto:someone@somewhere.co.uk?subject=I need help with my order {{ $order['id'] }}">someone@somewhere.co.uk</a>. </p>
                      </td>
                    </tr>
                    <tr>
